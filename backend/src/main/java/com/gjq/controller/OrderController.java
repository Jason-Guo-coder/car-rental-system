...
public class OrderController {
    ...
    public Result searchUnfinished(@PathVariable int start , @PathVariable int size , @RequestBody Order order){
        Page<Order> page = new Page<>(start,size);
        return Result.success(orderService.searchByPage(page,order));
    }
