...
export const menuConfig: MenuGroup[] = [
  ...
  },
  {
    group: '通用工具',
    items: [
      { title: 'Excel 导出', path: '/excel/export-excel', icon: 'Document' },
      { title: 'Excel 上传', path: '/excel/upload-excel', icon: 'Upload' },
      { title: 'Zip 导出', path: '/zip/download', icon: 'FolderOpened' },
      { title: 'PDF 打印', path: '/pdf/download', icon: 'Printer' },
    ],
  },
  {
    group: '系统管理',
