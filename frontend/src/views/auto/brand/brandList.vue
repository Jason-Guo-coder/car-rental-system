  ...
  <div class="app-container">
    <el-form :model="brandModel" :rules="rules" :inline="true" size="small" label-width="80px">
      ...
      <el-form-item label="品牌名称">
        <el-input v-model="brandModel.brandName" placeholder="请输入品牌名称" />
      </el-form-item>
      <el-form-item>
    ...
    >
      ...
      <el-table-column label="厂商名称" prop="makerName" />
    ...
    <el-dialog :title="titleMap[dialogStatus]" :visible.sync="dialogFormVisible" width="30%">
      <el-form ref="form" :model="saveBrand" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item label="品牌名称" prop="brandName">
          <el-input v-model="saveBrand.brandName" placeholder="请输入品牌名称" />
        </el-form-item>
      </el-form>
